...
model_name=PatchTST
model_identifier=electricity_linear_probing
dataset=electricity
input_length=512
...
do
    python -u src/self_supervised/pretrain_finetune_bootstrap.py \
        ...
        --no-finetune_mode \
        --linear_probe_mode \
        --bootstrap_iterations 5 --batch_size 64 >logs/self_supervised/linear_probing/$model_identifier'_'$input_length'_'$prediction_length.log 
done